                    ...
                    <div class="Advancde-Search list">     
                        <div id="advencedSearchResult">
                            ...
                            <el-table :data="matches" v-if="flag" key='firstTable'>
                                <el-table-column :label="$t('lang.AlbumTitle')" prop="catalogue_name">
                                ...
                                <el-table-column label="专辑信息" prop="dateline" >
                                    <template slot-scope="scope">
                                            ...
                                            <div class="message-list">
                                                <p>Category</p>
                                                <span>
                                                  <label v-for="(i,index) in scope.row.categories" :key="index">{{i}}</label>
                                                </span>
                                            </div>
                                            <div class="message-list">
                                                <p>Composer</p>
                                            ...
                                            <div class="message-list">
                                                <p>Artist</p>
                                                <span>
                                                  <label v-for="(i,index) in scope.row.artists" :key="index">{{i}}</label>
                                                </span>
                                            </div>
...
.Advancde-Search .el-pagination .el-pagination__total{
  padding-left:10px
}
.Advancde-Search .el-pagination .el-pagination__jump{
  float: right;
  margin-right:10px;
}
.Advancde-Search .list{
  padding-top:20px;
}
